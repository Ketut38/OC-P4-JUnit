...
public class ComptabiliteManagerImpl extends AbstractBusinessManager implements ComptabiliteManager {
	...
	@Override
	public JournalComptable getJournalComptableByCode(String codeJournal) {

		List<JournalComptable> journalComptableList = getListJournalComptable();
		JournalComptable journalComptable = new JournalComptable();

		for (JournalComptable pJournal : journalComptableList) {
			if (codeJournal.contentEquals(pJournal.getCode())) {
	...
	protected void checkRG5(EcritureComptable pEcritureComptable) throws FunctionalException {
		...
		String ref2 = ref.substring(3, 7); // BQ-2016/00000
		System.out.println(ref2);

		if (!ref2.equals(year)) {
			throw new FunctionalException("L'écriture comptable ne respecte pas RG5.");
		}
	}
	...
	protected void checkRG5Regex(EcritureComptable pEcritureComptable) throws FunctionalException {
		...
		if (matchRef == false) {
			throw new FunctionalException("La référence de l'écriture comptable ne satisfait pas la regex");
		}
	}
